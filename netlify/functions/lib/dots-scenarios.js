...
const POS_STATIC = [
  ...
  { id: 'q_field_bound', groups: ['QB', 'WR', 'DB'], off: 'gun11', def: 'over43', mode: 'choice',
  ...
  { id: 'w_stalk', groups: ['WR'], off: 'gun11', def: 'over43', mode: 'tap',
    q: 'Run play away from you. Tap the defender you stalk block.', answer: 'RC',
    why: 'The man over you. Nobody watches this on film except the coaches deciding whether you play.' },
...
const POS_MOTION = [
  ...
  { id: 'mq_bail', groups: ['QB', 'WR'], off: 'gun10', def: 'pressOff', mode: 'choice', snap: true,
