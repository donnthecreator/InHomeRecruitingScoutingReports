/* CommonJS copy of positions.js for serverless functions (report-pdf).
   Regenerate when positions.js changes: keep the two in sync. */
...
module.exports = { POSITIONS, GRADE_LABELS };
