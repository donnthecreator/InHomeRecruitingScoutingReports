...
const CORE = [
  { section: 'Personnel and formations', items: [
    ...
    { id: 'trips', retired: true, type: 'single', q: 'What is a trips formation?',
    ...
    { id: 'strength', retired: true, type: 'single', q: 'Formation strength is usually declared to',
  ...
  { section: 'Coverage recognition', items: [
    { id: 'c_two_high', retired: true, type: 'single', q: 'Two safeties deep, corners at seven yards with outside leverage. Most likely',
    ...
    { id: 'c_zero', retired: true, type: 'single', q: 'What tells you it is Cover 0?',
    ...
    { id: 'c_rotate', retired: true, type: 'single', q: 'Two high before the snap, one safety sprints to the middle at the snap. That is',
    ...
    { id: 'c_beat3', retired: true, type: 'single', q: 'Which concept most directly stresses Cover 3?',
  ...
  { section: 'Situational', items: [
    ...
    { id: 's_redzone', retired: true, type: 'text', q: 'The field shrinks inside the 20. In your own words, what changes for you between the 20 and the goal line?' }
  ]}
];
...
const BY_POSITION = {
  QB: [
    { section: 'Quarterback', items: [
      { id: 'qb_mike', retired: true, type: 'single', q: 'You point out the Mike before the snap. What is that mainly doing?',
      ...
      { id: 'qb_hot', retired: true, type: 'single', q: 'You count more rushers than you can block. What has to happen?',
      ...
      { id: 'qb_leverage', retired: true, type: 'single', q: 'A safety is aligned inside and deep over your slot. That takes away',
      ...
      { id: 'qb_progression', retired: true, type: 'single', q: 'Your first read is covered. The right habit is',
      ...
      { id: 'qb_rpo', retired: true, type: 'single', q: 'On an RPO, who are you actually reading?',
      ...
      { id: 'qb_protect_text', retired: true, type: 'text', q: 'Walk me through your pre-snap process from breaking the huddle to the snap. Everything you actually look at, in order.' },
  ...
  RB: [
    { section: 'Running back', items: [
      { id: 'rb_zone', retired: true, type: 'single', q: 'On outside zone, your first job is',
      ...
      { id: 'rb_gap', retired: true, type: 'single', q: 'On a power or gap scheme play, you should be',
      ...
      { id: 'rb_pass_pro', retired: true, type: 'single', q: 'You are in protection and nobody blitzes. You should',
      ...
      { id: 'rb_blitz', retired: true, type: 'single', q: 'A linebacker is coming free at you in protection. Where do you fit him?',
  ...
  WR: [
    { section: 'Receiver', items: [
      { id: 'wr_press', retired: true, type: 'single', q: 'Press man, corner with outside leverage. Your release should',
      ...
      { id: 'wr_split', retired: true, type: 'single', q: 'Your split (how wide you line up) mostly affects',
      ...
      { id: 'wr_cover2', retired: true, type: 'single', q: 'You are the outside receiver against Cover 2. The soft spot in your area is',
      ...
      { id: 'wr_scramble', retired: true, type: 'single', q: 'Your quarterback breaks the pocket and scrambles right. You should',
      ...
      { id: 'wr_block', retired: true, type: 'single', q: 'Run away from you on the backside. Who do you go get?',
  ...
  TE: [
    { section: 'Tight end', items: [
      { id: 'te_align', retired: true, type: 'single', q: 'Moving from attached on the line to the slot changes your job most by',
      ...
      { id: 'te_block', retired: true, type: 'single', q: 'On a down block, your first responsibility is',
      ...
      { id: 'te_lb', retired: true, type: 'single', q: 'A linebacker is covering you with inside leverage in man. That says',
  ...
  OL: [
    { section: 'Offensive line', items: [
      { id: 'ol_shade', retired: true, type: 'single', q: 'A defensive tackle is head up on your outside shoulder in the B gap area. What matters most about that alignment?',
      ...
      { id: 'ol_combo', retired: true, type: 'single', q: 'On a combination block with the guard, when do you come off to the linebacker?',
      ...
      { id: 'ol_slide', retired: true, type: 'single', q: 'The protection slides left. Your responsibility is',
      ...
      { id: 'ol_twist', retired: true, type: 'single', q: 'The end and tackle run a twist. You and the guard should',
  ...
  DL: [
    { section: 'Defensive line and edge', items: [
      { id: 'dl_gap', retired: true, type: 'single', q: 'The single most important thing on any run down is',
      ...
      { id: 'dl_down', retired: true, type: 'single', q: 'The lineman in front of you blocks down away from you. That usually means',
      ...
      { id: 'dl_pass_run', retired: true, type: 'single', q: 'Your fastest pass-run key is usually',
      ...
      { id: 'dl_rush', retired: true, type: 'single', q: 'You have beaten your man inside twice with the same move. Next pass down you should',
  ...
  LB: [
    { section: 'Linebacker', items: [
      { id: 'lb_pull', retired: true, type: 'single', q: 'You see a guard pull toward the other side. Your first thought is',
      ...
      { id: 'lb_fit', retired: true, type: 'single', q: 'On a run to your side, filling your gap means',
      ...
      { id: 'lb_hook', retired: true, type: 'single', q: 'You are dropping to the hook or curl zone. You should be',
      ...
      { id: 'lb_play_action', retired: true, type: 'single', q: 'Play action pulls you up and the tight end runs behind you. The mistake was',
  ...
  DB: [
    { section: 'Defensive back', items: [
      { id: 'db_leverage', retired: true, type: 'single', q: 'You have inside leverage with a safety over the top. You are protecting',
      ...
      { id: 'db_split', retired: true, type: 'single', q: 'A receiver reduces his split way inside. That most often signals',
      ...
      { id: 'db_cover2', retired: true, type: 'single', q: 'You are the corner in Cover 2. Your job is',
      ...
      { id: 'db_run', retired: true, type: 'single', q: 'Run play comes to your side and you are the force defender. That means',
      ...
      { id: 'db_eyes', retired: true, type: 'single', q: 'In off zone coverage, your eyes should be on',
  ...
  K: [
    { section: 'Specialist', items: [
      ...
      { id: 'k_wind', retired: true, type: 'text', q: 'How does wind change your approach and your target line? Be specific.' },
